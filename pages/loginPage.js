        ...
        <SafeAreaView style={styleView.safeArea}>
          ...
          <View style={styles.upper}>
              ...
              <View style={{ flexDirection: 'row', marginTop: height * 0.02 }}>
                <Text style={[styleText.textSmall, { fontFamily: 'Ubuntu-Medium' }]}>Don't have an account?</Text>
                <TouchableOpacity onPress={() => navigation.navigate('SignUp')}>
                  <Text style={[styleText.textSmall, { color: colors1.buttonColor, marginLeft: width * 0.01 }]}>Sign up</Text>
                </TouchableOpacity>
              </View>
            </View>
          </View>
